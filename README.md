...
- *Площадь под огибающей АКФ* — энергия остаточной корреляции после вычета АКФ модельного импульса
- *Максимульный побочный пик* — амплитуда максимального пика АКФ после вычета АКФ модельного импульса
